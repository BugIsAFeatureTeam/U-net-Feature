...
class myAugmentation(object):
    ...
    def doAugmentate(self, img, save_to_dir, save_prefix, batch_size=1, save_format='tif', imgnum=190):
        """
...
class dataProcess(object):
    ...
    #              data_path="C:/Users/Malikoto/unet-master/data/Dataset/train/image",
    #              label_path="C:/Users/Malikoto/unet-master/data/Dataset/train/label",
    #              test_path="C:/Users/Malikoto/unet-master/data/Dataset/test",
    #              npy_path="C:/Users/Malikoto/unet-master/data/Dataset/npydata",
    #              img_type="tif"):
    def __init__(self, out_rows, out_cols, data_path="./data/Dataset/train/image", label_path="./data/Dataset/train/label",
                 test_path="./data/Dataset/test", npy_path="./data/Dataset/npydata/", img_type="tif"):
        """
    ...
    def create_train_data(self):
        ...
        for imgname in imgs:
            ...
            print(imgname, midname, self.data_path + "/" + midname)
